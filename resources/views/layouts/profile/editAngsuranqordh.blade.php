        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                        <form action="/anggota/profile/updateangsuranqordh/{{$angsuran->id_angsuran_qordh}}" method="POST">
                            @csrf
                            <!--card-body -->
                            <div class="card-body col-sm-6">
                                <div class="form-group">
                                    <label for="id_angsuran_qordh">ID Angsuran</label>
                                    <input type="id" class="form-control col-md-4" name="id_angsuran_qordh" value="A200{{$angsuran->id_angsuran_qordh}}" readonly>
                                </div>
                                <div class="form-group">
