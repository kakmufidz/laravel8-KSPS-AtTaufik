        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                        <form action="/angsuran/mudorobah/tambah" method="post">
                            <!--card-body -->
                            @csrf
                                ...
                                <div class="form-group">
                                  ...
                                  @else
                                    <div class="input-group mb-3">
                                      ...
                                      <input class="form-control bg-danger" name="data_mudorobah" value="{{$detailAnggota->name}} | {{$detailMudorobah->tgl}} | {{$detailMudorobah->jenis_usaha}} = Rp. @currency($detailMudorobah->jumlah)" readonly>
                                    </div>
                                  @endif
                                </div>
                                <div class="form-group">
