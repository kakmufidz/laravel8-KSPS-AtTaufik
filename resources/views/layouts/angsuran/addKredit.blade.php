        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                        <form action="/angsuran/kredit/tambah" method="post">
                            <!--card-body -->
                            @csrf
                            <div class="card-body col-md-6">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group mb-3">
                                    <input class="form-control bg-danger col-sm-2" name="id_kredit" value="{{$detailKredit->id_kredit}}" readonly>
                                    <input class="form-control bg-danger" name="data_kredit" value="{{$detailAnggota->name}} | {{$detailKredit->tgl}} | {{$detailKredit->jumlah}} X {{$detailKredit->nama_barang}} = Rp. @currency($detailKredit->total_harga)" readonly>
                                  </div>
                                  @endif
                                </div>
                                <div class="form-group">
