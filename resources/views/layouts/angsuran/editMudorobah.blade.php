        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                        <form action="/angsuran/mudorobah/update/{{$angsuran->id_angsuran_mudorobah}}" method="POST">
                            @csrf
                            <!--card-body -->
                            <div class="card-body col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="data_mudorobah" value="{{$angsuran->data_mudorobah}}" readonly>
